...
| Xiaohongshu (Image notes) | Image gallery | ✅ 4 bugs fixed in v0.3.3 (still active in v0.6.8) |
...
> `pip install "vidknot[bundled-ffmpeg] @ git+https://github.com/suonian/vidknot.git@v0.6.8"`
>
> Environment self-check: `python -m vidknot --check-env` (prints install commands for anything missing)

The current GitHub release is `v0.6.8`. Install from GitHub:
...
>   "vidknot @ git+https://github.com/suonian/vidknot.git@v0.6.8"
> ```
>
