...
当前 GitHub Release 是 `v0.6.8`。推荐直接安装该版本：
...
```bash
pip install "vidknot[feishu] @ git+https://github.com/suonian/vidknot.git@v0.6.8"
```
...
```bash
pip install -i https://pypi.tuna.tsinghua.edu.cn/simple "vidknot @ git+https://github.com/suonian/vidknot.git@v0.6.8"
```
